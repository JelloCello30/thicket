...
const SITES: Record<string, SiteEntry> = {
  ...
  "williams-sonoma.com": { name: "Williams Sonoma", category: "shopping" },
  "rei.com": { name: "REI", category: "shopping" },
  "homedepot.com": { name: "Home Depot", category: "shopping" },
  "lowes.com": { name: "Lowe's", category: "shopping" },
  "nordstrom.com": { name: "Nordstrom", category: "shopping" },
  "macys.com": { name: "Macy's", category: "shopping" },
  "zappos.com": { name: "Zappos", category: "shopping" },
  "crateandbarrel.com": { name: "Crate & Barrel", category: "shopping" },
  "westelm.com": { name: "West Elm", category: "shopping" },
  "sephora.com": { name: "Sephora", category: "shopping" },
  "chewy.com": { name: "Chewy", category: "shopping" },
  ...
  // Scholarly sources. Without these they fall to category "other", which is a
  // wildcard — so a PubMed page saying "protein folding" could not join the
  // protein-folding group sitting right next to it.
  "nature.com": { name: "Nature", category: "reference" },
  "science.org": { name: "Science", category: "reference" },
  "ncbi.nlm.nih.gov": { name: "PubMed", category: "reference" },
  "semanticscholar.org": { name: "Semantic Scholar", category: "reference" },
  "biorxiv.org": { name: "bioRxiv", category: "reference" },
  "medrxiv.org": { name: "medRxiv", category: "reference" },
  "sciencedirect.com": { name: "ScienceDirect", category: "reference" },
  "springer.com": { name: "Springer", category: "reference" },
  "link.springer.com": { name: "Springer", category: "reference" },
  "jstor.org": { name: "JSTOR", category: "reference" },
  "ieee.org": { name: "IEEE", category: "reference" },
  "ieeexplore.ieee.org": { name: "IEEE Xplore", category: "reference" },
  "acm.org": { name: "ACM", category: "reference" },
  "dl.acm.org": { name: "ACM Digital Library", category: "reference" },
  "researchgate.net": { name: "ResearchGate", category: "reference" },
  "openreview.net": { name: "OpenReview", category: "reference" },
  "overleaf.com": { name: "Overleaf", category: "docs" },
